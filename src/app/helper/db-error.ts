...
export const PrismaKnownError = (
  error: Prisma.PrismaClientKnownRequestError,
): TErrorResponse => {
  const status_code = StatusCodeError(error.code);
...
export const PrismaUnknownError = (
...
export const PrismaValidationError = (
...
export const PrismaInitializationError = (
  error: Prisma.PrismaClientInitializationError,
): TErrorResponse => {
  const status_code = error.errorCode
    ? StatusCodeError(error.errorCode)
...
export const PrismaRustPanicError = (): TErrorResponse => {
  const errorSource: TErrorSource[] = [
    {
      path: "Rust Engine Crashed",
      message: "The database engine encountered a fatal error and crashed.",
    },
  ];
